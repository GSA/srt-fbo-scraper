...
class Predict:
    ...
    def transform_text(doc):
        ...
        stop_words = {
            ...
            "themselves", "then", "there", "these", "they", "this", "those", "through", "to", "too", "until", "up", 
    ...
    def insert_predictions(self, opps_data=None):
        ...
        for opp in data:
            ...
            if "attachments" in opp:
                ...
                logger.log(
                    level=15,
                    msg="Statistics for notice {} {}".format(
                        opp["agency"], opp["solnbr"]
                    ),
                    extra={
                ...
                if opp["compliant"] == 1:
                    logger.log(
                        level=16,
                        msg="Notice {} {} is predectied to be COMPLIANT".format(
                            opp["agency"], opp["solnbr"]
                        ),
                    )
                else:
                    logger.log(
                        level=16,
                        msg="Notice {} {} is predectied to be not compliant".format(
                            opp["agency"], opp["solnbr"]
                        ),
                    )
