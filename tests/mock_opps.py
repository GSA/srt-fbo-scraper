...
mock_opp_one = [
    {
        ...
        "solicitation": {
            ...
            "setAside": {
                "code": "SBA",
                "value": "Total Small Business Set-Aside (FAR 19.5)",
            },
        },
        "suggestion": {
            "input": ["27 inch monitors", "fy19-12306", "fy1912306"],
        ...
        "pointOfContacts": [
            {
                "phone": "8052280442",
                "fullName": "RACHEL T. SMITH",
                "fax": "8052285718",
                "type": "primary",
                "title": "Contract Specialist",
                "email": "RACHEL.T.SMITH@NAVY.MIL",
            }
        ],
        ...
        "solicitationNumber": "FY19-12306",
        "additionalReporting": ["none"],
        "award": {
            "date": "2019-12-10",
            "number": "N6339420P0004",
            "amount": 391977.02,
            "awardee": {
                "name": "MILLI MICRO SYSTEMS, INC.",
                "duns": "033273660",
                "location": {
                    "zip": None,
                    "country": "USA",
            ...
            "justificationAuthority": {
                "authority": {"code": None, "value": None},
                "modificationNumber": None,
            },
            "additionalInfo": "MILLI MICRO SYSTEMS, INC.",
            "deliveryOrderNumber": None,
            "fairOpportunity": {"authority": {"code": None, "value": None}},
        },
        "cleanSolicitationNumber": "FY1912306",
        "archiveDate": "2019-12-25T00:00:00-05:00",
        "modifiedDate": "2019-12-25T23:56:37-05:00",
        ...
        "_id": "532e8551391a4ba784e1e186656b6a39",
        "naics": [
            {
                "code": "334118",
                "id": 5433,
...
mock_opp_two = [
    {
        ...
        "cleanSolicitationNumber": "36C10E20Q0061",
        "archiveDate": "2020-01-07T00:00:00-05:00",
        "organizationHierarchy": [
            {
                "organizationId": "100006568",
                "address": {
                    "zip": None,
                    "country": "US",
                    "city": None,
            ...
            },
            {
                ...
                "level": 3,
                "name": "VBA FIELD CONTRACTING (36C10E)",
                "type": "OFFICE",
                "status": "active",
            },
        ],
        ...
        "suggestion": {
            "input": [
                'r--on-site shredding services | hrc - balt | 392  "tiered evaluations - for small business"  ',
                "36c10e20q0061",
                "36c10e20q0061",
            ],
            "contexts": {"isActive": True},
        ...
        "pointOfContacts": [
            {
                "additionalInfo": {"content": "kimberly.tomasi@va.gov"},
                "fullName": "Kimberly M Tomasi\nContract Specialist\n401-223-3777",
                "type": "primary",
                "email": "kimberly.tomasi@va.gov",
            }
        ],
        "_type": "opportunity",
        "indexedDate": "2020-01-08T00:01:55-05:00",
        "placeOfPerformance": [
            {
                "zip": None,
                "city": None,
        ...
        "solicitationNumber": "36C10E20Q0061",
        "modifiedDate": "2020-01-07T23:55:40-05:00",
        "_id": "998f586f5e1d4237bafaac483c5d9966",
        "naics": [
            {"code": "561990", "id": 1921, "value": "All Other Support Services"}
        ],
    }
]
    ...
    "attachments": [
        {
            ...
            "prediction": 0,
            "decision_boundary": 0.4534431418190372,
            "validation": None,
            "trained": False,
            "machine_readable": False,
            "filename": "JA Redacted.pdf",
        }
    ],
    "classcod": None,
    "naics": "5",
...
mock_transformed_opp_bad_attachment = {
    ...
    "compliant": 0,
    "office": "office",
    "attachments": [mock_bad_attachment_data],
    "classcod": "test",
    "naics": "test",
    "subject": "test",
    "url": "https://beta.sam.gov/opp/123/view",
