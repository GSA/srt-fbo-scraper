...
`$ git add [file.name]`
 ...
 #### Reviewing your Code
 You can review pull requests at https://github.com/GSA/fbo-scraper/pulls. If you like the code, you can merge it into master by pressing the big green Merge button. And then you're done!
