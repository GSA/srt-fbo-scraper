...
class SAMAPITestCase(unittest.TestCase):
    ...
    def test_requests_retry_session(self):
        ops = get_opps.get_yesterdays_opps(limit=100, filter_naics=True)
    ...
    def test_schematize_opps(self):
        opps = get_opps.get_yesterdays_opps(limit=100, filter_naics=True)
        op = opps[0]
    ...
    def test_transform(self):
        opps = get_opps.get_yesterdays_opps(limit=10, filter_naics=True)
